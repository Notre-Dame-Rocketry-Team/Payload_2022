""" subscale_filter_test.py
    
    Demonstrate midflight Kalman filtering, delete after testing and confirmation
"""
...
if __name__ == '__main__':
    ...
    while True:
        ...
        t2 = time.time()
        midflight_filter = MidflightFilter(1e-5, .3**2, 10.0)
        a_x = data[1]
        a_x_filtered = MidflightFilter.process_data(a_x)
